...
|---------|-------------|-------|
| [`update-knowledge`](./command/update-knowledge.md) | Update agent instruction files when code changes (handles instruction consistency and .opencode command sync) | `/update-knowledge` |
...
| [`gocyclo`](./command/gocyclo.md) | Analyze code complexity and suggest refactoring for functions with 15+ complexity | `/gocyclo` |
