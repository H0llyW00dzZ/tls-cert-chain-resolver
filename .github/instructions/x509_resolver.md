...
**CLI Flags**:
- `--config` / `-c`: Specify MCP server configuration file path (can be overridden via `MCP_X509_CONFIG_FILE` environment variable)
- `--instructions` / `-i`: Display certificate operation workflows and usage instructions
